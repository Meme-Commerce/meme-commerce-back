 ...
 * <p>
 * 해시태그의 생성, 수정, 삭제 및 조회 등 핵심 비즈니스 로직을 정의합니다.
 * 관리자의 해시태그 관리 및 일반 사용자 검색, 자동완성 등에도 활용될 수 있습니다.
 * </p>
 *
...
public interface HashtagServiceV1 {
   ...
   * 해시태그(여러 개)를 생성합니다.
   * <p>
   * 해시태그명 리스트를 받아 한 번에 여러 해시태그를 등록합니다.
   * 욕설/중복 검증, 유효성 검사 등을 포함할 수 있습니다.
   * </p>
   *
   ...
   * 해시태그의 이름을 수정합니다.
   * <p>
   * 지정된 해시태그 ID의 이름을 새로운 값으로 변경합니다.
   * 욕설/중복 검증 등도 내부에서 처리될 수 있습니다.
   * </p>
   *
   ...
   * 여러 해시태그를 일괄 삭제합니다.
   * <p>
   * 해시태그 ID 리스트를 받아 해당하는 해시태그를 모두 삭제합니다.
   * 존재하지 않는 ID, 연관 무결성 등도 내부에서 처리됩니다.
   * </p>
   *
   ...
   * <p>
   * 내부적으로 사용되는 메소드로, 해시태그 엔티티를 직접 반환합니다.
   * 상세 정보, 수정/삭제 등 다양한 비즈니스 로직에서 활용됩니다.
   * </p>
   *
